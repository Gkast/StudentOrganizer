...
public final class EventsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        EventAdapter adapter = new EventAdapter(getContext(), getAllItems());
    ...
    private Cursor getAllItems() {
        return database.query(
                ...
                null, null, null,
                null, null, EventContract.EventEntry.COLUMN_SELECTED_DAY +
                        "," + EventContract.EventEntry.COLUMN_START_HOUR
